local Tables = {
 ...
 if not isfile("VortexHook") then
    makefolder("VortexHook")
 end
 ...
 local library = {
    Title = 'VortexHook | <font color="rgb(189, 172, 255)">universal</font>',
    AnimatedText = false,
 ...
 task.spawn(function()
    local textList = { 
        '', 'V', 'Vo', 'Vor', 'Vort', 'Vorte', 'Vortex', 'Vortex', 'Vortex.<font color="rgb(189, 172, 255)">Hook</font>',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font>', 'Vortex<font color="rgb(189, 172, 255)">Hook</font>',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> |', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | u',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> | un', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | uni',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> | univ', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | univers',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> | universa', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | universal',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> | universa', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | univers',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> | univer', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | unive',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> | univ', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | uni',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> | un', 'Vortex<font color="rgb(189, 172, 255)">Hook</font> | u',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font> |', 'Vortex<font color="rgb(189, 172, 255)">Hook</font>',
        'Vortex<font color="rgb(189, 172, 255)">Hook</font>', 'Vortex<font color="rgb(189, 172, 255)">Hook</font>',
        'Vortex', 'Vortex', 'Vorte', 'Vort', 'Vor', 'Vo', 'V', ''
    }
    while wait(0.5) do
        if library.AnimatedText then
            ...
            menu.bg.pre.Text = 'VortexHook | <font color="rgb(189, 172, 255)">fallen</font>'
        end
    end
 end)  
                         ...
                         function library:addTab(name,image)
                            ...
                            function contains(list, x)
                               for _, v in pairs(list) do
                                  ...
                                  writefile("VortexHook/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                               ...
                               function library:deleteConfig()
                                  ...
                                  function library:refreshConfigs()
                                     local tbl = {}
                                     for i,v in next, listfiles("VortexHook") do table.insert(tbl,v) end
